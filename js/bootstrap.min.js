...
!(function(t, e) {
	...
	var r,
			...
			Object.keys(n).forEach(function(i) {
				var o,
					...
					a =
						r && m(r)
							? 'element'
							: null == (o = r) ? '' + o : {}.toString.call(o).match(/\s([a-z]+)/i)[1].toLowerCase();
		...
		O = ((l = new CustomEvent('Bootstrap', { cancelable: !0 })),
		...
		wt = (function() {
			...
			return (
				...
				(i._getConfig = function(t) {
					return (
						(t = s(s(s({}, this.constructor.Default), et.getDataAttributes(this._element)), t)),
						...
						if ('Escape' === t.key)
							return (
								(this.matches('[data-toggle="dropdown"]')
									? this
									: nt.prev(this, '[data-toggle="dropdown"]')[0]).focus(),
								void e.clearMenus()
							);
						if (i && 'Space' !== t.key) {
			...
			return (
				...
				(i.setElementContent = function(t, e) {
					if (null !== t)
						return 'object' == typeof e && m(e)
							...
							: void (this.config.html
									? (this.config.sanitize && (e = jt(e, this.config.whiteList, this.config.sanitizeFn)),
										(t.innerHTML = e))
									: (t.textContent = e));
				}),
				(i.getTitle = function() {
				...
				(i._getContainer = function() {
					return !1 === this.config.container
						? document.body
						: m(this.config.container) ? this.config.container : nt.findOne(this.config.container);
				}),
				...
				(i._getConfig = function(t) {
					...
					return (
						...
						'number' ==
							typeof (t = s(s(s({}, this.constructor.Default), e), 'object' == typeof t && t ? t : {}))
	...
	var Zt = 'scrollspy',
		...
		ee = (function() {
			...
			return (
				...
				(e._getConfig = function(t) {
					if (
						'string' != typeof (t = s(s({}, Jt), 'object' == typeof t && t ? t : {})).target &&
						m(t.target)
					) {
						var e = t.target.id;
	...
	q.on(document, 'click.bs.tab.data-api', '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(
		t
	) {
